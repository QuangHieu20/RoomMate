<template>
  <div class="h-full bg-gray-50">
    ...
    <div class="flex flex-1 min-h-0 h-[calc(100vh-190px)]">
      <!-- Chat List Sidebar -->
      <div
        class="w-1/3 border-r border-gray-200 bg-white flex flex-col h-full overflow-hidden"
      >
        <ChatList
      ...
      <div class="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <div v-else class="flex-1 flex flex-col">
              ...
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-500">
                    ...
                    >
                    <span v-else
                      >Hoạt động {{ selectedChat.lastMessage.time }}</span
                    >
                  </p>
                </div>
              </div>
          ...
          <!-- Messages Area -->
          <div
            class="flex-1 overflow-y-auto p-6 space-y-4 bg-gray-50 min-h-0 max-h-[calc(100vh-340px)]"
          >
            <!-- Sample Messages -->
            <div class="flex justify-start">
              <div class="flex items-start gap-3 max-w-[70%]">
                ...
                <div
                  class="bg-white rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm"
                >
                  <p class="text-gray-900">
                    Chào bạn! Mình thấy bạn đang tìm phòng trọ ở khu vực này
                  </p>
            ...
            <div class="flex justify-end">
              <div class="flex items-start gap-3 max-w-[70%] flex-row-reverse">
                ...
                <div
                  class="bg-cyan-500 text-white rounded-2xl rounded-tr-sm px-4 py-3 shadow-sm"
                >
                  <p>
                    Đúng rồi, mình đang tìm phòng trọ gần trường Đại học Bách
                    Khoa
                  </p>
            ...
            <div class="flex justify-start">
              <div class="flex items-start gap-3 max-w-[70%]">
                ...
                >
                  <p class="text-gray-900">
                    Tuyệt! Mình có phòng trọ ở đường Lê Lợi, cách trường 5 phút
                    đi bộ
                  </p>
            ...
            <div class="flex justify-start">
              <div class="flex items-start gap-3 max-w-[70%]">
                ...
                >
                  <p class="text-gray-900">
                    3.5 triệu/tháng, bao điện nước. Phòng có điều hòa, wifi,
                    nước nóng
                  </p>
          ...
          <div class="bg-white border-t border-gray-200 p-4">
            <div class="flex items-center gap-3">
              <button
                class="p-2 text-gray-400 hover:text-cyan-500 transition-colors"
              >
                <svg
                  class="w-5 h-5"
                  fill="none"
              ...
              <div
                class="flex-1 flex items-center bg-gray-100 rounded-full px-4 py-2"
              >
                <input
                  v-model="newMessage"
                  type="text"
                ...
                />
                <button
                  class="p-1 text-gray-400 hover:text-cyan-500 transition-colors"
                >
                  <svg
                    class="w-5 h-5"
                    fill="none"
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Trò chuyện với người dùng khác trên RoomMate',
    },
  ],
});
</script>
