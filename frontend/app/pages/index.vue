          ...
          >
              ...
              <div class="card w-96 min-h-48">
                <figure>
                  <video controls class="w-full min-h-48 rounded-t-xl">
                    <source
                      src="https://www.youtube.com/watch?v=cjR-BWQzxNs&list=RDcjR-BWQzxNs&start_radio=1"
                      type="video/mp4"
                    />
            ...
            <div class="w-full min-w-0 flex items-center justify-between mt-6">
                ...
                <BaseButton
                  ...
                  @click="
                    openPostModal({
                      id: 'test',
                      title:
                        'Tìm phòng trọ Quận 1 hoặc Quận 3, ngân sách 3 triệu',
                      description:
                        'Mình là sinh viên năm 2, cần tìm 1 phòng trọ hoặc ở ghép gần trung tâm để tiện đi học và làm thêm.',
                      requirements: [
              ...
              <div class="flex items-center justify-end w-1/6">
                <BaseButton class="!rounded-[4px]" size="md" variant="info">
                  Liên hệ
                </BaseButton>
              </div>
            </div>
          ...
          >
            ...
            <div class="mt-6">
              <div class="card w-full">
                <FullBleedCarousel :images="carouselImages" />
              </div>
            </div>
            <!-- Control -->
            <div class="w-full min-w-0 flex items-center justify-between mt-6">
    ...
    <div class="w-4/12 pt-[70px]">
      ...
      <div class="w-[95%] ml-3 card">
        <div class="flex justify-between items-center mb-3">
          ...
          <button class="btn btn-link text-cyan-500 hover:text-cyan-600">
            Xoá
          </button>
        </div>
          ...
          <div v-show="collapseStates.time" class="px-4 pb-4">
            ...
            <div class="flex items-center space-x-2">
              <input
                type="text"
                placeholder="Từ"
                class="input w-1/2 bg-gray-100 border-none focus:outline-none"
              />
              <ArrowRightIcon
                class="w-5 h-5 rounded-full font-bold bg-yellow-100 p-1 text-yellow-500"
              />
              <input
                type="text"
                placeholder="Đến"
        ...
        <div class="bg-base-100 rounded-lg mb-4 overflow-hidden">
          ...
          <div v-show="collapseStates.address" class="px-4 pb-4">
            <div class="grid grid-cols-2 gap-4 mb-4">
              <select
                class="select w-full bg-gray-100 border-none focus:outline-none"
              >
            ...
            <select
              class="select w-[48%] bg-gray-100 border-none focus:outline-none"
            >
          ...
          <div v-show="collapseStates.address" class="px-4 pb-4">
            ...
            <div class="space-y-2 mt-4 ml-2">
              <label class="flex items-center">
                <input
                  type="checkbox"
                  class="checkbox checkbox-primary border-gray-500"
                />
