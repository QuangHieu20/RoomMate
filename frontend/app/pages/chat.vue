...
<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="flex flex-col h-[calc(100vh-80px)]">
      <!-- Messages Area -->
      <div
        class="flex-1 overflow-y-auto p-6 space-y-4 max-h-[calc(100vh-300px)]"
      >
        <!-- Sample Messages -->
        ...
        <div class="flex justify-end">
          <div class="flex items-start gap-3 max-w-[70%] flex-row-reverse">
            ...
            >
              <p>
                Đúng rồi, mình đang tìm phòng trọ gần trường Đại học Bách Khoa
              </p>
        ...
        <div class="flex justify-start">
          <div class="flex items-start gap-3 max-w-[70%]">
            ...
            <div class="bg-white rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm">
              <p class="text-gray-900">
                Tuyệt! Mình có phòng trọ ở đường Lê Lợi, cách trường 5 phút đi
                bộ
              </p>
        ...
        <div class="flex justify-start">
          <div class="flex items-start gap-3 max-w-[70%]">
            ...
            <div class="bg-white rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm">
              <p class="text-gray-900">
                3.5 triệu/tháng, bao điện nước. Phòng có điều hòa, wifi, nước
                nóng
              </p>
