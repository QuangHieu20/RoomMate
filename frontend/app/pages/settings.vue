<template>
  <div class="w-full h-full bg-white p-8">
    <!-- Header -->
    <div class="mb-8">
      <h2 class="text-3xl font-bold text-gray-800 mb-4">Cài đặt</h2>
      <p class="text-gray-600 text-sm">Quản lý cài đặt tài khoản và ứng dụng</p>
    </div>
        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-xs text-gray-500">
                Cho phép người khác xem thông tin liên hệ
              </p>
            </div>
            <label class="relative inline-flex items-center cursor-pointer">
              <input
