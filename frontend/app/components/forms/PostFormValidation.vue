    ...
    >
      ...
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-2">
          {{ $t('post.create.fields.title') }}
          <span class="text-red-500">*</span>
        </label>
        <VField v-slot="{ field, errorMessage }" name="title">
          <input
            v-bind="field"
            type="text"
      ...
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-2">
          {{ $t('post.create.fields.price') }}
          <span class="text-red-500">*</span>
        </label>
        <VField v-slot="{ field, errorMessage }" name="price">
          <input
            v-bind="field"
            type="number"
      ...
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-2">
          {{ $t('post.create.fields.description') }}
          <span class="text-red-500">*</span>
        </label>
