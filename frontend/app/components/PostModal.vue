  ...
  >
    <div class="space-y-6">
      ...
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <h4 class="font-semibold text-gray-900">
            {{ post?.author.name || 'Nguyễn Quang Hiếu' }}
          </h4>
          <p class="text-sm text-gray-500">
            {{ post?.author.timestamp || '25/09/2025 12:24 PM' }}
          </p>
        </div>
      </div>
      ...
      >
        <div class="flex items-center gap-6">
          ...
          <BaseButton variant="ghost" size="sm" class="flex items-center gap-2">
        ...
        <BaseButton variant="info" size="md" @click="handleContact">
          Liên hệ
        </BaseButton>
      </div>
    ...
    <template #footer>
      <div class="flex items-start gap-2 w-full max-w-full">
        ...
        <div
          class="flex-1 flex flex-col items-start gap-2 bg-gray-100 rounded-[18px] p-2 min-w-0"
        >
          <input
            v-model="newComment"
            type="text"
