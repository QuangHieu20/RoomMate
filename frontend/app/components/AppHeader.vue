...
import { UserCircleIcon, BellIcon, ChatBubbleLeftRightIcon, PencilIcon } from '@heroicons/vue/24/outline'
...
<template>
  <div class="w-11/12 h-[82px] mx-auto flex justify-between items-center py-2 bg-white">
    <!-- Logo -->
    <div class="w-3/12">
      <NuxtLink to="/">
        <img
