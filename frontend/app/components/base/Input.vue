...
const inputClasses = computed(() => {
  ...
  const variantClasses = {
    ...
    bordered:
      'input input-bordered bg-gray-100 focus:bg-white focus:border-cyan-500',
    ...
    <div v-if="$slots.subTitle" class="inline-flex items-stretch w-full">
      ...
      <div class="flex-1">
        ...
        <input
          ...
          :class="[
            inputClasses,
            'w-full border-r-0 rounded-r-none rounded-l-lg',
          ]"
          :value="modelValue"
          @input="handleInput"
        ...
        <textarea
          ...
          :class="[
            inputClasses,
            'textarea textarea-bordered resize-none w-full border-r-0 rounded-r-none rounded-l-lg',
          ]"
          :value="modelValue"
          @input="handleInput"
          @change="handleFieldChange"
      ...
      <div
        class="bg-gray-200 text-cyan-500 px-3 flex items-center border border-gray-300 rounded-r-lg border-l-0"
      >
